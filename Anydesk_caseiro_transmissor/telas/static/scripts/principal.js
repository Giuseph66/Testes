        ...
        .then(data => {
          ...
          if (messages && messages.length > lastIndex) {
            ...
            for (let i = lastIndex; i < messages.length; i++) {
              ...
              copia.innerHTML = '<img src="' + STATIC_URL + 'imgs/copia.png"  alt="Copiar" style="width:20px;height:20px;"><span class="tooltip">Copiar</span>';

              copia.addEventListener("click", function () {
                navigator.clipboard.writeText(msg.dialogo)
                  .then(() => {
                    copia.innerHTML = '<img src="' + STATIC_URL + 'imgs/copia.png"  alt="Copiar" style="width:20px;height:20px;"><span class="tooltip">Copiado</span>';
