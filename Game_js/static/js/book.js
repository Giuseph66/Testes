...
function generateDynamicLeaves(abilities) {
    ...
    frontCoverBackPage.innerHTML = '<h1>Escolha suas habilidades</h1>';
    ...
    abilities.forEach((ability, index) => {
      ...
      // Adiciona a classe "ability" para diferenciar das capas
      leaf.className = 'leaf dynamic ability';
      // Ajusta o atributo data-leaf conforme a ordem (a capa da frente é leaf 0)
      ...
      <p>${ability.description}</p>
        <button onclick="purchaseAbility('${ability.name}')">
          ${level > 0 ? 'Atualizar' : 'Comprar'} (${cost} Runas)
        </button>`;
      
      const backPage = document.createElement('div');
      backPage.className = 'page back';
      backPage.innerHTML = `<h1>Era uma vez...</h1><p>${ability.legend}</p>`;
...
function updateBook() {
  const abilities = [
    { name: 'Teletransporte', description: 'Permite teletransportar-se para frente.' },
    { name: 'Clone Sombrio', description: 'Cria um clone sombrio.' },
    { name: 'Controle do Tempo', description: 'Permite controlar o tempo, diminuindo a gravidade.' },
    { name: 'Mundo Invertido', description: 'Inverte a direção do movimento.' },
    { name: 'Voar', description: 'Permite ao jogador voar por um curto período.' },
    { name: 'Raio Laser', description: 'Dispara um raio laser para frente.' },
    { name: 'Escalada', description: 'Permite ao jogador escalar paredes.' },
    { name: 'Espectro', description: 'Transforma o jogador em um espectro invencível.' },
    { name: 'Espada Sagrada', description: 'Aumenta o poder de ataque do jogador.' },
    { name: 'Efeito Bumerangue', description: 'Lança um bumerangue que retorna ao jogador.' },
    { name: 'Forma Aquática', description: 'Permite ao jogador nadar rapidamente.' },
    { name: 'Congelamento', description: 'Congela os inimigos ao redor.' },
    { name: 'Fúria', description: 'Aumenta a velocidade e o poder de ataque do jogador.' },
    { name: 'Mina Programável', description: 'Coloca uma mina no chão que explode ao contato.' },
    { name: 'Lâmina Giratória', description: 'Cria uma lâmina giratória ao redor do jogador.' },
    { name: 'Cura Gradual', description: 'Regenera a saúde do jogador gradualmente.' },
    { name: 'Armadilha de Espinhos', description: 'Coloca uma armadilha de espinhos no chão.' },
    { name: 'Corda/Gancho', description: 'Permite ao jogador usar um gancho para se mover rapidamente.' },
    { name: 'Elo Espiritual', description: 'Conecta a saúde do jogador à de um inimigo.' },
    { name: 'Super Sopro', description: 'Empurra os inimigos para longe.' }
  ];
